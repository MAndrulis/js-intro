...
//const info = child.marks[child.marks.length -1];
//const cMarks = child.marks;
//const info = child.marks[cMarks.length -1];

//const marksCount = child.marks.length ;
//const info = child.marks[child.marks.length -1];
...
const info = child.parents.at(-1).phones[1];
